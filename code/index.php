...
<body>
  <div id="main">
    <div id="header">
      <div id="logo">
        <div id="logo_text">
        <h1> MINH VU'S Motorcycle Store</h1>     
        </div>
      </div>
      <div id="menubar">
        <ul id="menu">
    ...
    <div id="site_content">
      ...
      while ($std = mysqli_fetch_array($rst1)) { ?>
        <div class="std_detail">
          <div class="std_image">
            <a href="bike_detail.php?bikeID=<?= $std['bike_id'] ?>">
            <img src='admin\images\bike\<?= $std['bike_image']?>' width="120" height="80"> 
            </a>
          </div> <br>
          <div class="std_info"> 
            <?= $std['bike_name'] ?> <br> <br>
  ...
  <div id="footer" style="margin-bottom: 30px;">
          Vo Chi Cong, Tay Ho, Ha Noi. <u> Contact:</u> 0899899888</h1> <br>
          An Duong Vuong, Kim Tan, Lao Cai. <u> Contact:</u> 0866046666
    </div>
